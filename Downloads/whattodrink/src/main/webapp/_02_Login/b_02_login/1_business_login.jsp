...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/_02_Login/b_02_login/style.css"/>" />
    <link rel="stylesheet" href="<c:url value="/_02_Login/b_02_login/register_and_login.css"/>" />
    <title>登入</title>
  </head>
  <body>
      ...
      <div class="focus container">
        ...
        <div class="row">
          <div class="col-10 mx-auto">
            <h4 class="mb-4">請輸入帳號密碼</h4>
            <form id="account" method="post" action="<c:url value='/_02_Login/B_LoginServlet.do'/>">
              <div class="mb-4">
                <input
                  type="text"
            ...
            <div class="mt-2">
              <span>
                忘記密碼前往<a
                  ...
                  href="<c:url value="/_02_Login/b_02_login/1_business_forgot_password.jsp"/>"
                  >重設密碼</a
                ></span
              >
            </div>
 ...
 <!-- footer start -->
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
    <script src="./1_business_login.js"></script>
  </body>
</html>
